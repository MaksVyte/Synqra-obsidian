...
/**
 * Binary mux protocol: every WebSocket frame is
 *   [docId : varString][msgType : varUint][payload : varUint8Array (optional)]
 * This is the exact framing from the proven reference implementation, so the
 * Rust server speaks the same wire format.
 */
